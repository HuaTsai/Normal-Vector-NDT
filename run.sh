...
devel/lib/sndt_exec/test_path -i ../Analysis/1Data/log62-1/vepcs.ser -o /tmp/path2.ser -u 1 -m 1
...
devel/lib/sndt_exec/test_path -i ../Analysis/1Data/log62-2/vepcs.ser -o /tmp/path3.ser -u 1 -m 1
...
# SICP
devel/lib/sndt_exec/test_path -i ../Analysis/1Data/log24/vepcs.ser -o /tmp/path.ser -u 1 -m 2
devel/lib/tool/pathtotext -e /tmp/path.ser -g ../Analysis/1Data/log24/gt.ser -o ../Analysis/20210802/results/pc/sicp/pc_sicp_log24

devel/lib/sndt_exec/test_path -i ../Analysis/1Data/log62-1/vepcs.ser -o /tmp/path2.ser -u 1 -m 2
devel/lib/tool/pathtotext -e /tmp/path2.ser -g ../Analysis/1Data/log62-1/gt.ser -o ../Analysis/20210802/results/pc/sicp/pc_sicp_log62-1
