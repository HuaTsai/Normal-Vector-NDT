...
int main() {
  ...
  //       ("cellsize,c", po::value<double>(&cell_size)->default_value(1.5),
  //       "Cell Size")
  //       ("voxel,v", po::value<double>(&voxel)->default_value(0), "Downsample
  //       voxel")
  //       ("huber,u", po::value<double>(&huber)->default_value(1.0), "Use Huber
  //       loss")
  //       ("radius,a", po::value<double>(&radius)->default_value(1.5), "Use
  //       Huber loss")
