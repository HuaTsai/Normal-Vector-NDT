...
class NMap {
 ...
 public:
  ...
  /**
   * @brief Load points into the NMap
   *
  ...
  /**
   * @brief Load points and covariances into the NMap
   *
   * @param points Points to load
   * @param point_cov Same covariance for all points
   */
  void LoadPointsWithCovariances(const std::vector<Eigen::Vector3d> &points,
                                 const Eigen::Matrix3d &point_cov);

  /**
   * @brief Load points and point covariances into the NMap
   *
   * @param points Points to load
  ...
  /**
   * @brief Perform transformation to NMap
   *
